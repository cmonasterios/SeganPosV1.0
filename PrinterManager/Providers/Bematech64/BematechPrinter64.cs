using PrinterManager.Providers.Bematech64.Extension;
using System;
...
{
  public class BematechPrinter64 : PrinterProviderBase
  {
    ...
    public override string[] ProgramarAlicuota(params string[] args)
    {
      ...
      if (args.Length >= 1) {
        iResult = classBematech64.Bematech_FI_ProgramaAlicuota(args[0], Convert.ToInt32(args[1]));
        strError = classBematech64.Analiza_iRetorno(iResult);
        strRetorno = classBematech64.Analiza_RetornoImpresora();
      }
      else
    ...
    public override string[] ProgramarRedondeo(params string[] args)
    {
      ...
      iResult = classBematech64.Bematech_FI_ProgramaRedondeo();
      strError = classBematech64.Analiza_iRetorno(iResult);
      strRetorno = classBematech64.Analiza_RetornoImpresora();
    ...
    public override string[] ProgramarTruncamiento(params string[] args)
    {
      ...
      iResult = classBematech64.Bematech_FI_ProgramaTruncamiento();
      strError = classBematech64.Analiza_iRetorno(iResult);
      strRetorno = classBematech64.Analiza_RetornoImpresora();
    ...
    public override string[] AbrirComprobanteVenta(params string[] args)
    {
      ...
      if (args.Length >= 1) {
        iResult = classBematech64.Bematech_FI_AbreComprobanteDeVenta(args[0], args[1]);
        strError = classBematech64.Analiza_iRetorno(iResult);
        strRetorno = classBematech64.Analiza_RetornoImpresora();
      }
      else
    ...
    public override string[] AbrirComprobanteVentaExtendido(params string[] args)
    {
      ...
      if (args.Length >= 2) {
        iResult = classBematech64.Bematech_FI_AbreComprobanteDeVentaEx(args[0], args[1], args[2]);
        strError = classBematech64.Analiza_iRetorno(iResult);
        strRetorno = classBematech64.Analiza_RetornoImpresora();
      }
      else
    ...
    public override string[] VenderArticulo(params string[] args)
    {
      ...
      if (args.Length >= 9) {
        iResult = classBematech64.Bematech_FI_VendeArticulo(args[0], args[1], args[2], args[3], args[4], Convert.ToInt32(args[5]), args[6], args[7], args[8]);
        strError = classBematech64.Analiza_iRetorno(iResult);
        strRetorno = classBematech64.Analiza_RetornoImpresora();
      }
      else
    ...
    public override string[] AnularArticulo(params string[] args)
    {
      ...
      iResult = classBematech64.Bematech_FI_AnulaArticuloAnterior();
      strError = classBematech64.Analiza_iRetorno(iResult);
      strRetorno = classBematech64.Analiza_RetornoImpresora();
    ...
    public override string[] AnularComprobante(params string[] args)
    {
      ...
      iResult = classBematech64.Bematech_FI_AnulaCupon();
      strError = classBematech64.Analiza_iRetorno(iResult);
      strRetorno = classBematech64.Analiza_RetornoImpresora();
    ...
    public override string[] CerrarComprobante(params string[] args)
    {
      ...
      if (args.Length >= 6) {
        iResult = classBematech64.Bematech_FI_CierraCupon(args[0], args[1], args[2], args[3], args[4], args[5]);
        strError = classBematech64.Analiza_iRetorno(iResult);
        strRetorno = classBematech64.Analiza_RetornoImpresora();
      }
      else
    ...
    public override string[] IniciarCierreComprobante(params string[] args)
    {
      ...
      if (args.Length >= 3) {
        iResult = classBematech64.Bematech_FI_IniciaCierreCupon(args[0], args[1], args[2]);
        strError = classBematech64.Analiza_iRetorno(iResult);
        strRetorno = classBematech64.Analiza_RetornoImpresora();
      }
      else
    ...
    public override string[] EfectuarPago(params string[] args)
    {
      ...
      if (args.Length >= 2) {
        iResult = classBematech64.Bematech_FI_EfectuaFormaPago(args[0], args[1]);
        strError = classBematech64.Analiza_iRetorno(iResult);
        strRetorno = classBematech64.Analiza_RetornoImpresora();
      }
      else
    ...
    public override string[] EfectuaFormaPagoDescripcionForma(params string[] args)
    {
      ...
      if (args.Length >= 2) {
        iResult = classBematech64.Bematech_FI_EfectuaFormaPagoDescripcionForma(args[0], args[1], args[2]);
        strError = classBematech64.Analiza_iRetorno(iResult);
        strRetorno = classBematech64.Analiza_RetornoImpresora();
      }
      else
    ...
    public override string[] FinalizarCierreComprobante(params string[] args)
    {
      ...
      if (args.Length >= 1) {
        iResult = classBematech64.Bematech_FI_FinalizarCierreCupon(args[0]);
        strError = classBematech64.Analiza_iRetorno(iResult);
        strRetorno = classBematech64.Analiza_RetornoImpresora();
      }
      else
    ...
    public override string[] DevolverArticulo(params string[] args)
    {
      ...
      if (args.Length >= 9) {
        iResult = classBematech64.Bematech_FI_DevolucionArticulo(args[0], args[1], args[2], args[3], args[4], Convert.ToInt32(args[5]), args[6], args[7], args[8]);
        strError = classBematech64.Analiza_iRetorno(iResult);
        strRetorno = classBematech64.Analiza_RetornoImpresora();
      }
      else
    ...
    public override string[] AbrirNotaCredito(params string[] args)
    {
      ...
      if (args.Length >= 10) {
        iResult = classBematech64.Bematech_FI_AbreNotaDeCredito(args[0], args[1], args[2], args[3], args[4], args[5], args[6], args[7], args[8], args[9]);
        strError = classBematech64.Analiza_iRetorno(iResult);
        strRetorno = classBematech64.Analiza_RetornoImpresora();
      }
      else
    ...
    public override string[] ImpresionCintaDetalle(params string[] args)
    {
      ...
      if (args.Length >= 4) {
        iResult = classBematech64.Bematech_FI_ImpresionCintaDetalle(args[0], args[1], args[2], args[3]);
        strError = classBematech64.Analiza_iRetorno(iResult);
        strRetorno = classBematech64.Analiza_RetornoImpresora();
      }
      else
    ...
    public override string[] LecturaX(params string[] args)
    {
      ...
      iResult = classBematech64.Bematech_FI_LecturaX();
      strError = classBematech64.Analiza_iRetorno(iResult);
      strRetorno = classBematech64.Analiza_RetornoImpresora();
    ...
    public override string[] LecturaXSerial(params string[] args)
    {
      ...
      iResult = classBematech64.Bematech_FI_LecturaXSerial();
      strError = classBematech64.Analiza_iRetorno(iResult);
      strRetorno = classBematech64.Analiza_RetornoImpresora();
    ...
    public override string[] ReduccionZ(params string[] args)
    {
      ...
      string strRetorno = string.Empty;
      if (args.Length >= 2) {
        iResult = classBematech64.Bematech_FI_ReduccionZ(args[0], args[1]);
        strError = classBematech64.Analiza_iRetorno(iResult);
        strRetorno = classBematech64.Analiza_RetornoImpresora();
      }
      else
    ...
    public override string[] InformeGerencial(params string[] args)
    {
      ...
      string strRetorno = string.Empty;
      if (args.Length >= 1) {
        iResult = classBematech64.Bematech_FI_InformeGerencial(args[0]);
        strError = classBematech64.Analiza_iRetorno(iResult);
        strRetorno = classBematech64.Analiza_RetornoImpresora();
      }
      else
    ...
    public override string[] CierreInformeGerencial(params string[] args)
    {
      ...
      iResult = classBematech64.Bematech_FI_CierraInformeGerencial();
      strError = classBematech64.Analiza_iRetorno(iResult);
      strRetorno = classBematech64.Analiza_RetornoImpresora();
    ...
    public override string[] LecturaMemoriaFiscalSerialReduccion(params string[] args)
    {
      ...
      string strRetorno = string.Empty;
      if (args.Length >= 1) {
        iResult = classBematech64.Bematech_FI_LecturaMemoriaFiscalSerialReduccion(args[0], args[1]);
        strError = classBematech64.Analiza_iRetorno(iResult);
        strRetorno = classBematech64.Analiza_RetornoImpresora();
      }
      else
    ...
    public override string[] RecebimientoNoFiscal(params string[] args)
    {
      ...
      string strRetorno = string.Empty;
      if (args.Length >= 3) {
        iResult = classBematech64.Bematech_FI_RecebimientoNoFiscal(args[0], args[1], args[2]);
        strError = classBematech64.Analiza_iRetorno(iResult);
        strRetorno = classBematech64.Analiza_RetornoImpresora();
      }
      else
    ...
    public override string[] AbreComprobanteNoFiscalVinculado(params string[] args)
    {
      ...
      string strRetorno = string.Empty;
      if (args.Length >= 3) {
        iResult = classBematech64.Bematech_FI_AbreComprobanteNoFiscalVinculado(args[0], args[1], args[2]);
        strError = classBematech64.Analiza_iRetorno(iResult);
        strRetorno = classBematech64.Analiza_RetornoImpresora();
      }
      else
    ...
    public override string[] ImprimeComprobanteNoFiscalVinculado(params string[] args)
    {
      ...
      string strRetorno = string.Empty;
      if (args.Length >= 1) {
        iResult = classBematech64.Bematech_FI_ImprimeComprobanteNoFiscalVinculado(args[0]);
        strError = classBematech64.Analiza_iRetorno(iResult);
        strRetorno = classBematech64.Analiza_RetornoImpresora();
      }
      else
    ...
    public override string[] CierraComprobanteNoFiscalVinculado(params string[] args)
    {
      ...
      string[] strError = new string[] { string.Empty, string.Empty };
      string strRetorno = string.Empty;
      iResult = classBematech64.Bematech_FI_CierraComprobanteNoFiscalVinculado();
      strError = classBematech64.Analiza_iRetorno(iResult);
      strRetorno = classBematech64.Analiza_RetornoImpresora();
    ...
    public override string[] Sangria(params string[] args)
    {
      ...
      string strRetorno = string.Empty;
      if (args.Length >= 1) {
        iResult = classBematech64.Bematech_FI_Sangria(args[0]);
        strError = classBematech64.Analiza_iRetorno(iResult);
        strRetorno = classBematech64.Analiza_RetornoImpresora();
      }
      else
    ...
    public override string[] Provision(params string[] args)
    {
      ...
      string strRetorno = string.Empty;
      if (args.Length >= 2) {
        iResult = classBematech64.Bematech_FI_Provision(args[0], args[1]);
        strError = classBematech64.Analiza_iRetorno(iResult);
        strRetorno = classBematech64.Analiza_RetornoImpresora();
      }
      else
    ...
    public override string[] Agregado([MarshalAs(UnmanagedType.VBByRefStr)] ref string ValorIncrementos)
    {
      ...
      string[] strError = new string[] { string.Empty, string.Empty };
      string strRetorno = string.Empty;
      iResult = classBematech64.Bematech_FI_Agregado(ref ValorIncrementos);
      strError = classBematech64.Analiza_iRetorno(iResult);
      strRetorno = classBematech64.Analiza_RetornoImpresora();
    ...
    public override string[] Cancelamientos([MarshalAs(UnmanagedType.VBByRefStr)] ref string ValorCancelamientos)
    {
      ...
      string[] strError = new string[] { string.Empty, string.Empty };
      string strRetorno = string.Empty;
      iResult = classBematech64.Bematech_FI_Cancelamientos(ref ValorCancelamientos);
      strError = classBematech64.Analiza_iRetorno(iResult);
      strRetorno = classBematech64.Analiza_RetornoImpresora();
    ...
    public override string[] DatosUltimaReduccion([MarshalAs(UnmanagedType.VBByRefStr)] ref string DatosReduccion)
    {
      ...
      string[] strError = new string[] { string.Empty, string.Empty };
      string strRetorno = string.Empty;
      iResult = classBematech64.Bematech_FI_DatosUltimaReduccion(ref DatosReduccion);
      strError = classBematech64.Analiza_iRetorno(iResult);
      strRetorno = classBematech64.Analiza_RetornoImpresora();
    ...
    public override string[] Descuentos([MarshalAs(UnmanagedType.VBByRefStr)] ref string ValorDescuentos)
    {
      ...
      string[] strError = new string[] { string.Empty, string.Empty };
      string strRetorno = string.Empty;
      iResult = classBematech64.Bematech_FI_Descuentos(ref ValorDescuentos);
      strError = classBematech64.Analiza_iRetorno(iResult);
      strRetorno = classBematech64.Analiza_RetornoImpresora();
    ...
    public override string[] NumeroCuponesAnulados([MarshalAs(UnmanagedType.VBByRefStr)] ref string NumeroCancelamientos)
    {
      ...
      string[] strError = new string[] { string.Empty, string.Empty };
      string strRetorno = string.Empty;
      iResult = classBematech64.Bematech_FI_NumeroCuponesAnulados(ref NumeroCancelamientos);
      strError = classBematech64.Analiza_iRetorno(iResult);
      strRetorno = classBematech64.Analiza_RetornoImpresora();
    ...
    public override string[] RetornoAlicuotas([MarshalAs(UnmanagedType.VBByRefStr)] ref string Alicuotas)
    {
      ...
      string[] strError = new string[] { string.Empty, string.Empty };
      string strRetorno = string.Empty;
      iResult = classBematech64.Bematech_FI_RetornoAlicuotas(ref Alicuotas);
      strError = classBematech64.Analiza_iRetorno(iResult);
      strRetorno = classBematech64.Analiza_RetornoImpresora();
    ...
    public override string[] LecturaMemoriaFiscalReduccion([MarshalAs(UnmanagedType.VBByRefStr)] ref string ReduccionInicial, [MarshalAs(UnmanagedType.VBByRefStr)] ref string ReduccionFinal)
    {
      ...
      string[] strError = new string[] { string.Empty, string.Empty };
      string strRetorno = string.Empty;
      iResult = classBematech64.Bematech_FI_LecturaMemoriaFiscalReduccion(ref ReduccionInicial, ref ReduccionFinal);
      strError = classBematech64.Analiza_iRetorno(iResult);
      strRetorno = classBematech64.Analiza_RetornoImpresora();
    ...
    public override string[] LecturaMemoriaFiscalFechaMFD([MarshalAs(UnmanagedType.VBByRefStr)] ref string FechaDesde, [MarshalAs(UnmanagedType.VBByRefStr)] ref string FechasHasta, [MarshalAs(UnmanagedType.VBByRefStr)] ref string FlagLectura)
    {
      ...
      string[] strError = new string[] { string.Empty, string.Empty };
      string strRetorno = string.Empty;
      iResult = classBematech64.Bematech_FI_LecturaMemoriaFiscalFechaMFD(ref FechaDesde, ref FechasHasta, ref FlagLectura);
      strError = classBematech64.Analiza_iRetorno(iResult);
      strRetorno = classBematech64.Analiza_RetornoImpresora();
    ...
    public override string[] FechaHoraImpresora([MarshalAs(UnmanagedType.VBByRefStr)] ref string Fecha, [MarshalAs(UnmanagedType.VBByRefStr)] ref string Hora)
    {
      ...
      string[] strError = new string[] { string.Empty, string.Empty };
      string strRetorno = string.Empty;
      iResult = classBematech64.Bematech_FI_FechaHoraImpresora(ref Fecha, ref Hora);
      strError = classBematech64.Analiza_iRetorno(iResult);
      strRetorno = classBematech64.Analiza_RetornoImpresora();
    ...
    public override string[] FechaHoraReducion([MarshalAs(UnmanagedType.VBByRefStr)] ref string Fecha, [MarshalAs(UnmanagedType.VBByRefStr)] ref string Hora)
    {
      ...
      string[] strError = new string[] { string.Empty, string.Empty };
      string strRetorno = string.Empty;
      iResult = classBematech64.Bematech_FI_FechaHoraReduccion(ref Fecha, ref Hora);
      strError = classBematech64.Analiza_iRetorno(iResult);
      strRetorno = classBematech64.Analiza_RetornoImpresora();
    ...
    public override string[] FechaHoraUltimoDocumento([MarshalAs(UnmanagedType.VBByRefStr)] ref string FechaHora)
    {
      ...
      string[] strError = new string[] { string.Empty, string.Empty };
      string strRetorno = string.Empty;
      iResult = classBematech64.Bematech_FI_FechaHoraUltimoDocumentoMFD(ref FechaHora);
      strError = classBematech64.Analiza_iRetorno(iResult);
      strRetorno = classBematech64.Analiza_RetornoImpresora();
    ...
    public override string[] AccionaGaveta()
    {
      ...
      string[] strError = new string[] { string.Empty, string.Empty };
      string strRetorno = string.Empty;
      iResult = classBematech64.Bematech_FI_AccionaGaveta();
      strError = classBematech64.Analiza_iRetorno(iResult);
      strRetorno = classBematech64.Analiza_RetornoImpresora();
    ...
    public override string[] Autenticacion()
    {
      ...
      string[] strError = new string[] { string.Empty, string.Empty };
      string strRetorno = string.Empty;
      iResult = classBematech64.Bematech_FI_Autenticacion();
      strError = classBematech64.Analiza_iRetorno(iResult);
      strRetorno = classBematech64.Analiza_RetornoImpresora();
    ...
    public override string[] ProgramaCaracterAutenticacion(params string[] args)
    {
      ...
      string strRetorno = string.Empty;
      if (args.Length >= 1) {
        iResult = classBematech64.Bematech_FI_ProgramaCaracterAutenticacion(args[0]);
        strError = classBematech64.Analiza_iRetorno(iResult);
        strRetorno = classBematech64.Analiza_RetornoImpresora();
      }
      else
    ...
    public override string[] VerificaEstadoGaveta(out int EstadoGaveta)
    {
      ...
      string[] strError = new string[] { string.Empty, string.Empty };
      string strRetorno = string.Empty;
      iResult = classBematech64.Bematech_FI_VerificaEstadoGaveta(out EstadoGaveta);
      strError = classBematech64.Analiza_iRetorno(iResult);
      strRetorno = classBematech64.Analiza_RetornoImpresora();
    ...
    public override string[] AbrePuertaSerial()
    {
      ...
      string[] strError = new string[] { string.Empty, string.Empty };
      string strRetorno = string.Empty;
      iResult = classBematech64.Bematech_FI_AbrePuertaSerial();
      strError = classBematech64.Analiza_iRetorno(iResult);
      strRetorno = classBematech64.Analiza_RetornoImpresora();
    ...
    public override string[] CierraPuertaSerial()
    {
      ...
      string[] strError = new string[] { string.Empty, string.Empty };
      string strRetorno = string.Empty;
      iResult = classBematech64.Bematech_FI_CierraPuertaSerial();
      strError = classBematech64.Analiza_iRetorno(iResult);
      strRetorno = classBematech64.Analiza_RetornoImpresora();
    ...
    public override string[] RetornoImpresora(ref int ACK, ref int ST1, ref int ST2)
    {
      ...
      string[] strError = new string[] { string.Empty, string.Empty };
      string strRetorno = string.Empty;
      iResult = classBematech64.Bematech_FI_RetornoImpresora(ref ACK, ref ST1, ref ST2);
      strError = classBematech64.Analiza_iRetorno(iResult);
      strRetorno = classBematech64.Analiza_RetornoImpresora();
    ...
    public override string VerificaEstadoImpresora(ref int ACK, ref int ST1, ref int ST2)
    {
      ...
      string[] strError = new string[] { string.Empty, string.Empty };
      string strRetorno = string.Empty;
      iResult = classBematech64.Bematech_FI_VerificaEstadoImpresora(ref ACK, ref ST1, ref ST2);
      strError = classBematech64.Analiza_iRetorno(iResult);
      strRetorno = classBematech64.Analiza_RetornoImpresora();
    ...
    public override string[] NumeroReducciones([MarshalAs(UnmanagedType.VBByRefStr)] ref string NumeroReducciones)
    {
      ...
      string[] strError = new string[] { string.Empty, string.Empty };
      string strRetorno = string.Empty;
      iResult = classBematech64.Bematech_FI_NumeroReducciones(ref NumeroReducciones);
      strError = classBematech64.Analiza_iRetorno(iResult);
      strRetorno = classBematech64.Analiza_RetornoImpresora();
    ...
    public override string[] NumeroCupon([MarshalAs(UnmanagedType.VBByRefStr)] ref string NumeroCupon)
    {
      ...
      string[] strError = new string[] { string.Empty, string.Empty };
      string strRetorno = string.Empty;
      iResult = classBematech64.Bematech_FI_NumeroCupon(ref NumeroCupon);
      strError = classBematech64.Analiza_iRetorno(iResult);
      strRetorno = classBematech64.Analiza_RetornoImpresora();
    ...
    public override string[] NumeroSerie([MarshalAs(UnmanagedType.VBByRefStr)] ref string NumeroSerie)
    {
      ...
      string[] strError = new string[] { string.Empty, string.Empty };
      string strRetorno = string.Empty;
      iResult = classBematech64.Bematech_FI_NumeroSerie(ref NumeroSerie);
      strError = classBematech64.Analiza_iRetorno(iResult);
      strRetorno = classBematech64.Analiza_RetornoImpresora();
    ...
    public override string[] NumeroComprobanteFiscal([MarshalAs(UnmanagedType.VBByRefStr)] ref string NumeroComprobanteFiscal)
    {
      ...
      string[] strError = new string[] { string.Empty, string.Empty };
      string strRetorno = string.Empty;
      iResult = classBematech64.Bematech_FI_NumeroComprobanteFiscal(ref NumeroComprobanteFiscal);
      strError = classBematech64.Analiza_iRetorno(iResult);
      strRetorno = classBematech64.Analiza_RetornoImpresora();
    ...
    public override string[] SubTotal([MarshalAs(UnmanagedType.VBByRefStr)] ref string SubTotal)
    {
      ...
      string[] strError = new string[] { string.Empty, string.Empty };
      string strRetorno = string.Empty;
      iResult = classBematech64.Bematech_FI_SubTotal(ref SubTotal);
      strError = classBematech64.Analiza_iRetorno(iResult);
      strRetorno = classBematech64.Analiza_RetornoImpresora();
    ...
    {
      return classBematech64.Bematech_FI_VerificaImpresoraPrendida();
    }

    public override int ResetaImpresora()
    {
      return classBematech64.Bematech_FI_ResetaImpresora();
    }
